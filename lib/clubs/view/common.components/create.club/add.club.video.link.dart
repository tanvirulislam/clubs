...
class AddClubVideoLink extends ConsumerWidget {
  const AddClubVideoLink({super.key});
    ...
    return Padding(
      ...
      child: context.isMobileWidth
          ? Column(
              ...
              children: [
                ClubTitle("Club's Video"),
                Row(
                  children: [
                    Expanded(
                      child: CustomTextField(
                        label: 'Enter Club\'s Video Link',
                        onChanged: (p0) {},
                      ),
                    ),
                    width10,
          ...
          : Row(
              children: [
                Expanded(child: ClubTitle("Club's Video")),
                width20,
                Expanded(
                  flex: 3,
                  child: Row(
